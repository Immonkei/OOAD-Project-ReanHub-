...
export default function Classes() {
  ...
  const isClassOwner = (classItem: Class) => {
    return user?.role === 'teacher' && classItem.teacher._id === user._id;
  };
        ...
        {classes.length === 0 ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {classes.map((classItem) => (
              <Card key={classItem._id} className="transition-all hover:shadow-lg">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="mb-1">{classItem.name}</CardTitle>
                    ...
                    {user?.role === "student" ? (
                      <>
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => handleLeaveClass(classItem._id, classItem.name)}
                          className="gap-2"
                        >
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-lg">{selectedClass.subject}</p>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => copyClassCode(selectedClass.classCode)}
                        className="gap-2"
                      >
                  ...
                  <div>
                    ...
                    <p className="text-lg">{selectedClass.students.length} students</p>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <Label className="font-semibold text-lg">Students</Label>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="border border-destructive/50 rounded-lg p-4 bg-destructive/5">
                  ...
                  <Button
                    ...
                    disabled={deleteLoading === selectedClass._id}
                  >
                    {deleteLoading === selectedClass._id ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                        Deleting Class...
                      </>
